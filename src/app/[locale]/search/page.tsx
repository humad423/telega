...
export default async function SearchPage({ 
  ...
  return (
    <>
      <main className="pt-4 lg:pt-24 pb-12 lg:pb-20 max-w-[1536px] mx-auto px-1.5 lg:px-6 flex flex-col lg:flex-row gap-4 lg:gap-8 min-h-screen font-['Inter','Tajawal']">
              ...
              {entries.map((item: any) => (
                <DirectoryCard 
                  ...
                  item={{
                    ...
                    type: item.type,
                    image: item.image_url || 'https://placehold.co//png',
