...
export default function NotFound() {
  return (
    <div className="min-h-[70vh] flex flex-col items-center justify-center p-6 text-center font-['Inter','Tajawal']">
      <div className="relative">
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-48 h-48 sm:w-64 sm:h-64 bg-primary/20 rounded-full blur-[60px] sm:blur-[80px] pointer-events-none"></div>
        <h1 className="text-[100px] sm:text-[150px] md:text-[180px] font-black leading-none text-transparent bg-clip-text bg-gradient-to-br from-primary to-amber-500 drop-shadow-xl select-none mb-2 relative z-10">
          404
        </h1>
      </div>
      ...
      <Link 
        href="/" 
        className="relative z-10 group inline-flex items-center justify-center gap-3 px-6 sm:px-8 py-3.5 sm:py-4 bg-slate-900 dark:bg-white text-white dark:text-slate-900 font-bold text-sm sm:text-base rounded-xl overflow-hidden transition-all hover:scale-105 hover:shadow-xl hover:shadow-primary/30 active:scale-95"
      >
